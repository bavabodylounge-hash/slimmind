...
- Name: aesthetic-salon-runner.spec.ts >> Suite S-1: result-salon.html 라우트 및 전역 변수 >> S-1-3: result-salon.html window.GOLDEN_TIME_MAP 노출
- Location: tests/e2e/aesthetic-salon-runner.spec.ts:76:3
