...
- Name: aesthetic-salon-runner.spec.ts >> Suite AE-1: aesthetic.html 전역 변수 노출 >> AE-1-6: EXERCISE_RESPONSE_OPTIONS 7가지 키 존재 (에스테틱)
- Location: tests/e2e/aesthetic-salon-runner.spec.ts:50:3
