...
- Name: aesthetic-salon-runner.spec.ts >> Suite S-1: result-salon.html 라우트 및 전역 변수 >> S-1-4: result-salon.html window.EXERCISE_RESPONSE_OPTIONS 노출
- Location: tests/e2e/aesthetic-salon-runner.spec.ts:83:3
