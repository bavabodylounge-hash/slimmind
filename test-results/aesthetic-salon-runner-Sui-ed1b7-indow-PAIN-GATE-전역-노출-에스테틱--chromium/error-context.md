...
- Name: aesthetic-salon-runner.spec.ts >> Suite AE-1: aesthetic.html 전역 변수 노출 >> AE-1-1: window.PAIN_GATE 전역 노출 (에스테틱)
- Location: tests/e2e/aesthetic-salon-runner.spec.ts:7:3
