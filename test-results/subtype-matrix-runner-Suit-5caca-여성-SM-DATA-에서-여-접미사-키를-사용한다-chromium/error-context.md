...
- Name: subtype-matrix-runner.spec.ts >> Suite 2: 성별 분기 로직 검증 >> 여성 __SM_DATA__에서 _여 접미사 키를 사용한다
- Location: tests/e2e/subtype-matrix-runner.spec.ts:197:3

# Error details

```
Error: 여성 분기 키 없음: 갱년기 호르몬스위치형_여
