...
- Name: aesthetic-salon-runner.spec.ts >> Suite AE-1: aesthetic.html 전역 변수 노출 >> AE-1-2: window.GOLDEN_TIME_MAP 전역 노출 (에스테틱)
- Location: tests/e2e/aesthetic-salon-runner.spec.ts:14:3
