...
- Name: subtype-matrix-runner.spec.ts >> Suite 1: SUBTYPE_NARR 86벌 완전성 검증 >> 공통아형 40개 _여 키 배치 검증
- Location: tests/e2e/subtype-matrix-runner.spec.ts:107:3

# Error details

```
Error: 누락된 _여 키: 식후졸음 혈당롤러코스터형_여, 약물유발 수분축적형_여, 코르티솔 야식부엉이형_여, 식욕억제제 포만감리셋형_여, 말벅지형_여, 승마살형_여, 하지정맥 부종형_여, 사이클링 하체비대형_여, 라운드숄더 등살형_여, 앞벅지 코어부재형_여, 거북목 경추압박형_여, 하지 림프정체형_여, 냉증·말초순환저하형_여, 갱년기 호르몬스위치형_여, 출산후 호르몬격변형_여, 갱년기 대사전환형_여, 장내세균 불균형형_여, 복부팽만 가스형_여, 근감소성 마른비만형_여, 스테로이드 근손실형_여, 다이어트반복형_여, 골반전방경사 허리통증형_여, 척추측만 체형불균형형_여, 감정식이 폭식형_여, 야식증후군형_여, 저탄수 반동폭식형_여, 지방간 대사증후군형_여, 인슐린저항성 당전단계형_여, 계획표완벽주의형_여, 즉흥폭식자유형_여, 수면무호흡 야간비만형_여, 수분부족 부종형_여, 스트레스 코르티솔집중형_여, 빈혈·철결핍 피로비만형_여, 갑상선기능저하형_여, 다낭성난소증후군(PCOS)형_여, 고혈압·항응고제형_여, 기저대사저하형_여
...
```ts
  22  | // 46아형 전체 목록 (설계도 정본 기준)
  23  | // ─────────────────────────────────────────────────────────────────────────────
  24  | const ALL_SUBTYPES_SHARED = [
  25  |   // 복부계
  26  |   '아빠체형 내장비대형', '식후졸음 혈당롤러코스터형', '약물유발 수분축적형',
  27  |   '코르티솔 야식부엉이형', '식욕억제제 포만감리셋형',
  28  |   // 하체계
  29  |   '말벅지형', '승마살형', '하지정맥 부종형', '사이클링 하체비대형',
  30  |   // 상체계
  31  |   '라운드숄더 등살형', '앞벅지 코어부재형', '거북목 경추압박형',
  32  |   // 림프·순환계
  33  |   '하지 림프정체형', '엄마체형 하지정체형', '냉증·말초순환저하형',
  34  |   // 전신·대사계
  35  |   '갱년기 호르몬스위치형', '출산후 호르몬격변형', '갱년기 대사전환형',
  36  |   // 소화·장계
  37  |   '장내세균 불균형형', '복부팽만 가스형',
  38  |   // 근감소계
