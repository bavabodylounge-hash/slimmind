...
- Name: aesthetic-salon-runner.spec.ts >> Suite AE-1: aesthetic.html 전역 변수 노출 >> AE-1-4: PAIN_GATE 키 구조 검증 (에스테틱)
- Location: tests/e2e/aesthetic-salon-runner.spec.ts:28:3
