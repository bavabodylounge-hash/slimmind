...
function calcDisposition(dispAnswers) {
  ...
  const ohaengIdx = dispAnswers['DISP_OHAENG'] || 00;
  ...
  const failMind  = dispAnswers['DISP_FAIL_MIND'] || 00;  // G10
